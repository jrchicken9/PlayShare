...
var typingClearTimers = /* @__PURE__ */ new Map();
var typingIdleTimer = null;
var TYPING_IDLE_MS = 1500;
var TYPING_PEER_CLEAR_MS = 3e3;
function $(id) {
...
function handleServerMessage(msg) {
  ...
  switch (t) {
    ...
    case "TYPING_STOP":
      if (msg.username) {
        const t2 = typingClearTimers.get(msg.username);
...
function updateTypingIndicator() {
  ...
  if (others.length === 0) {
    ...
    el.textContent = others.length === 1 ? `${others[0]} is typing…` : `${others.length} people typing…`;
